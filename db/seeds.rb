...
content_seeds = [{title: 'Escape to Alcatraz', excerpt: '<p>Alcatraz Island, 
  ...
  campus.</p>', url: 'http://chronicle.com/article/Lets-Help-Them-Speak-Up/135706/'}, {title: 
  ...
  The superstar is nice.</p>', url: 'http://www.startribune.com/entertainment/books/169664686.html'},
  ...
  realism, transplanted to the American South.</p>', url: 'http://www.startribune.com/entertainment/books/169664666.html?refer=y'},
  ...
  article/This-Bright-River-by-Patrick-Somerville-3723809.php'}, {title: 'Lena Dunham\'s <i>Girls</i>', 
  ...
  says. Hahahaha. Ya burnt, 23-year-old memoirist.</p>', url: 'http://bygonebureau.com/2012/04/16/the-lena-dunham-show/'},
  ...
  cycle of profitability very funny.</p>', url: 'http://www.startribune.com/entertainment/books/136599158.html'},
  ...
  'http://www.themillions.com/2011/10/getting-out-escaping-with-joan-didion.html'}, {title: 'Chucking
  ...
  in their current condition.<p>', url: 'http://300reviews.com/2011/07/27/98-chucking-your-v-s-naipaul-books-into-a-dumpster/'},
  ...
  http://www.theawl.com/2011/07/whats-invisible-at-harvard-a-conversation'}, {title: '<i>American Masculine</i>',
  excerpt: '<p>Ray\'s narratives often proceed in a nonlinear, mosaic fashion, a structure that at its best 
  has the effect of galvanizing a story\'s scenes into genuine emotion.</p>', url: 'http://www.startribune.com/entertainment/books/124438529.html'}, 
  ...
  'http://bygonebureau.com/2011/06/22/going-gray-conversations/'}, {title: 'On Expectations', excerpt:
  ...
  'http://www.theawl.com/2011/03/on-expectations-and-a-writers-lack-of-same'}, {title: 'First-Order
  ...
  is reached, which we will call the <b>equilibrium solution</b>.</p>', url: 'http://www.puertodelsol.org/assets/pdfs/45.2%20PDFs/culver-first-order-differential%20equations.pdf'},
  ...
  'http://twincitiesrunoff.com/2011/06/three-stories-by-sj-culver/'}, {title: '<i>Porch Sofa Almanac</i>', excerpt: '
  ...
  Internet and TV and all those new media."</p>', url: 'http://www.startribune.com/entertainment/books/103937433.html'},
  ...
  </p><p><b>No:</b> "I have scabies."</p>', url: 'http://therumpus.net/2010/07/funny-women-29-rules-for-emailing-your-instructor/'},
  ...
  http://300reviews.com/2009/12/23/14-your-conduct-and-aspect-on-public-transit/'}, {title: '<i>The Passage</i>: A Review,
  ...
  profit on the book saying, "You paid this guy HOW MUCH, NOW?"</p>', url: 'http://dislocate.umn.edu/writing/thepassage.html'},
  {title: 'The Cover of Jonathan Franzen\'s Forthcoming Novel, <i>Freedom</i>', excerpt: '<p>"FREEDOM," she said.</p>
  <p>"A NOVEL," I said.</p><p>Etc.</p>', url: 'http://300reviews.com/2010/06/04/46-the-cover-of-jonathan-franzens-forthcoming-novel-freedom/'},
  ...
  must respond.  Jessica Simpson typifies the new celebrity.</p>', url: 'http://another300reviews.wordpress.com/2010/01/28/1-reality-hunger-a-manifesto-by-david-shields'},
  ...
  url: 'http://300reviews.com/2009/11/25/5-joshua/'}, {title: 'Cee-Lo Green\'s "Fuck You!"', excerpt: '<p>The video for Cee-Lo 
  ...
  url: 'http://300reviews.com/2010/08/26/61-cee-lo-green%E2%80%99s-%E2%80%9Cfuck-you%E2%80%9D/'}]
